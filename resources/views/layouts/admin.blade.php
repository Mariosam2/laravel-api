...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap shadow px-3">
        <div class="container">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 ms-4 px-5 px-lg-3 fs-6 " href="#"><strong
                    class="fs-4">Boolfolio</strong></a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-5 sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link ms_nav-link {{ Route::currentRouteName() === 'admin.dashboard' ? 'ms_active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link ms_nav-link {{ str_contains(Route::currentRouteName(), 'admin.types') ? 'ms_active' : '' }}"
